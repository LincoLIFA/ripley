export class UsersChat {
  ...
  constructor(userId: string, name: string, avatar: string,
              lastChatTime: string, status: string, isPinnedUser: boolean, isMuted: boolean,
              unreadMessageCount: string, isActiveChat: boolean, lastChatMessage: string, chats: Chat[]) {
    this.userId = userId;
    this.name = name;
    this.avatar = avatar;
